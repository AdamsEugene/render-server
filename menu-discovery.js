  ...
  confirmNo() {
    ...
    if (state.pendingElement && !state.isConfirming) {
      ...
      notifyExtension({
        ...
        message: "Hover over a menu item in the header for 5 seconds to start detection.",
        showButtons: false,
        waiting: true,
      });
      return;
      ...
      if (detailsEl) {
        ...
        if (menuElement) {
          ...
          notifyExtension({
            ...
            message: "The page is frozen. Hover over the dropdown/popup menu for 2 seconds.",
            showButtons: false,
            waiting: true,
          });
